...
for i in range(0, 10*15, 15):
    url = f'https://movie.douban.com/subject_search?search_text={name}&cat=1002' + '&start=' + str(i)
    # url = f'https://movie.douban.com/subject_search?search_text={name}&cat=1002'
    print(url)
